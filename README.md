...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/repos-18-00D0FF?style=flat-square&labelColor=111827" alt="Repos"/>
...
| [sugra-api-mcp](https://github.com/Sugra-Systems/sugra-api-mcp) | 2 | MCP (Model Context Protocol) connector that gives LLM agents access to the Sugra API: 1,500+ endpoints aggregating 160+ primary sources across 36 data domains, including markets, macroeconomics, company fundamentals, government, news, climate, maritime, and entity screening. Ships as a PyPI package (`sugra-api-mcp`) and works with Anthropic Claude, OpenAI GPT, Google Gemini, xAI, and any MCP-enabled client. A hosted MCP endpoint is also available, so agents can connect without running anything locally. Python, MIT. |
...
| [openbb-sugra](https://github.com/Sugra-Systems/openbb-sugra) | 1 | Sugra data provider extension for the OpenBB Platform: one API key adds market, economic, news, regulatory, and maritime data as standard OpenBB fetchers. Installs alongside any OpenBB deployment and follows the platform's provider interface. Python, AGPL-3.0. |
